...
local function run_repl(frameId, expression)
    ...
    local ref
    res[2], ref = variables.createRef(res[2], expression, "repl")
    for i = 3, res.n do
...
local function run_hover(frameId, expression)
    ...
    local res, ref = variables.createRef(res, expression, "hover")
    return true, res, ref
end
...
local function run_watch(frameId, expression)
    ...
    local ref
    res[2], ref = variables.createRef(res[2], expression, "watch")
    for i = 3, res.n do
